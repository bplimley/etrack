...
:fDefaultMaterial(0),fSolidWorld(0),fLogicWorld(0),fPhysiWorld(0),
 ...
 fMagField(0)
{
  // parameter values of the calorimeter: make a single huge block.
  fNbOfAbsor = 1;
  fAbsorThickness[1] = 20*m;
  fNbOfLayers        = 1;
  fCalorSizeYZ       = 20.*m;
...
void DetectorConstruction::DefineMaterials()
{
  ...
  G4Element* Cd = manager->FindOrBuildElement(48);
  G4Element* Zn = manager->FindOrBuildElement(30);
  G4Element* Te = manager->FindOrBuildElement(52);
  ...
  new G4Material("Germanium",	z=32., a= 72.60*g/mole,  density= 5.32*g/cm3);
  new G4Material("SiliconSimple", z=14., a=28.09*g/mole, density= 2.33*g/cm3);
