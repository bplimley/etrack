...
public:
 ...
 ~RunAction();
  ...
  void AddVerboseEventInformation(G4String);
  void WriteVerboseEventInformation();
  void setSaveFilenameDir   (G4String val)        { SaveFilenameDir   = val;};
...
private:
  ...
  G4String EventInformationOut;
  // Output File
  std::ostringstream StatisticsOut;
  //messenger
  G4String SaveFilenameDir;
