...
%LRC:
loadpath = ['/global/scratch/bcplimley/multi_angle/newtracks',foldernum,'out/t1/'];
...
%LRC:
savepath = ['/global/scratch/bcplimley/multi_angle/newtracks',foldernum,'_HT/t1/'];
...
flist = dir(fullfile(loadpath,[loadpre,'16_11',loadsuf]));
